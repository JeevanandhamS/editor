...
public class QuoteSpanTagHandler extends SpanTagHandler.Simple<QuoteSpan> {

    private static final String[] TAGS = {"blockquote"};

    public QuoteSpanTagHandler() {
    ...
    @Override
    public QuoteSpan buildSpanForTag(String name, Attributes a, String context) {
